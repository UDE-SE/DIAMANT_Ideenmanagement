<!--This file is based on originals provided by keycloak (see https://github.com/keycloak/keycloak).
In accordance with the Apache 2 license we want you to notice that we changed parts of the original content.  -->
...
<#--        <title>${msg("loginTitle",(realm.displayName!''))}</title>-->
        <title>DIAMANT - Vorschlagwesen</title>
        ...
        <link rel="stylesheet" href="${url.resourcesPath}/css/bulma.min.css" />
        <style type="text/css">
            .nav-container {
                flex-grow: 1;
                margin: 0 auto;
